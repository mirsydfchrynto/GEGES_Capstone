...
void main() {
  testWidgets('TermsPage shows terms text and has appbar', (
    WidgetTester tester,
  ) async {
    ...
    expect(
      find.textContaining('GEGES SmartBarber - Terms of Service'),
      findsOneWidget,
    );
  });

  testWidgets('PrivacyPage shows privacy text and has appbar', (
    WidgetTester tester,
  ) async {
    ...
    expect(
      find.textContaining('GEGES SmartBarber - Privacy Policy'),
      findsOneWidget,
    );
  });
}
