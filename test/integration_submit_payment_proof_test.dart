...
void main() {
  test('submitPaymentProofForQueue updates payment fields atomically', () async {
    ...
    await svc.submitPaymentProofForQueue(queueId: docRef.id, userId: 'user123', base64Proof: 'proof-blob-123');
  ...
  test('submitPaymentProofForQueue enforces ownership', () async {
    ...
    expect(
      svc.submitPaymentProofForQueue(queueId: docRef.id, userId: 'user123', base64Proof: 'x'),
