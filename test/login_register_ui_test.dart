...
void main() {
  group('LoginScreen UI Tests', () {
    testWidgets('TC-LOGIN-UI-01: LoginScreen renders dengan elements utama', (WidgetTester tester) async {
    ...
    testWidgets('TC-LOGIN-UI-02: Email validation error saat format salah', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: LoginScreen(),
        ),
    ...
    testWidgets('TC-LOGIN-UI-03: Empty field validation', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: LoginScreen(),
        ),
    ...
    testWidgets('TC-LOGIN-UI-04: Password visibility toggle', (WidgetTester tester) async {
    ...
    testWidgets('TC-LOGIN-UI-05: Tab navigation to Sign Up', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: LoginScreen(),
        ),
  ...
  group('RegisterScreen UI Tests', () {
    testWidgets('TC-REGISTER-UI-01: RegisterScreen renders dengan elements utama', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: RegisterScreen(),
        ),
    ...
    testWidgets('TC-REGISTER-UI-02: Form validation - empty fields', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: RegisterScreen(),
        ),
    ...
    testWidgets('TC-REGISTER-UI-03: Form validation - invalid email', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: RegisterScreen(),
        ),
    ...
    testWidgets('TC-REGISTER-UI-04: Form validation - password too short', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: RegisterScreen(),
        ),
    ...
    testWidgets('TC-REGISTER-UI-05: Form validation - passwords don\'t match', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: RegisterScreen(),
        ),
    ...
    testWidgets('TC-REGISTER-UI-06: Form validation - name too short', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: RegisterScreen(),
        ),
    ...
    testWidgets('TC-REGISTER-UI-07: Password visibility toggle works', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: RegisterScreen(),
        ),
    ...
    testWidgets('TC-REGISTER-UI-08: Tab navigation to Login', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: RegisterScreen(),
        ),
  ...
  group('Navigation Tests', () {
    testWidgets('TC-NAV-01: Login to Register navigation', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: LoginScreen(),
        ),
    ...
    testWidgets('TC-NAV-02: Register to Login presence of Log in tab', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: RegisterScreen(),
        ),
