...
var createTenantGuard_1 = require("../src/createTenantGuard");
if (admin.apps.length === 0) {
    admin.initializeApp();
}
// Minimal unit test: ensures unauthenticated call fails
test('unauthenticated call throws', function () { return __awaiter(void 0, void 0, void 0, function () {
    var data, context;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                // @ts-ignore
                return [4 /*yield*/, expect((0, createTenantGuard_1.createTenantGuard)(data, context)).rejects.toThrow()];
            case 1:
                // cast function to unknown then to any to avoid syntax issues in some babel parsers if needed, 
                // or just use bracket notation if it's exported.
                // Actually, let's just use it directly and see if typing allows it or use a simpler cast.
