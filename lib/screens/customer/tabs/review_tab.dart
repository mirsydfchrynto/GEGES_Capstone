  ...
  final List<Map<String, dynamic>> _dummyReviews = [
    {
      ...
      "rating": 5.0,
      "date": "2d ago",
      "comment": "Tempatnya nyaman dan bersih. Barbermannya (Agus) sangat profesional dan hasilnya rapi. Pasti balik lagi!",
      "image": "https://placehold.co/100x100/C3A47B/000000?text=IF" // Placeholder foto profil
    },
    {
      "name": "Budi Santoso",
      "rating": 4.0,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      const Icon(Icons.star, color: Color(0xFFC3A47B), size: 16),
                      const SizedBox(width: 4),
                      Text(
                        review['rating'].toString(), 
                        style: const TextStyle(color: Color(0xFFC3A47B), fontWeight: FontWeight.bold)
                      ),
                    ],
                  ),
                ],
