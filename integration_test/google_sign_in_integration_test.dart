...
void main() {
  ...
  final runIntegration = const bool.fromEnvironment('RUN_GOOGLE_INTEGRATION', defaultValue: false);

  testWidgets('INT-GOOGLE-01: Google Sign-In interactive smoke test', (WidgetTester tester) async {
    if (!runIntegration) {
