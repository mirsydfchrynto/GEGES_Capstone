...
void main() {
  ...
  testWidgets('integration: submitPaymentProofForQueue (transactional) - passes on device', (WidgetTester tester) async {
    ...
    await svc.submitPaymentProofForQueue(queueId: docRef.id, userId: 'integration_user', base64Proof: 'proof-integ');
